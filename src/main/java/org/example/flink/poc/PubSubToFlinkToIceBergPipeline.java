...
public class PubSubToFlinkToIceBergPipeline {
    public static void main(String[] args) throws Exception {
        ...
        GoogleCredentials googleCredentials = GoogleCredentials.fromStream(PubSubToFlinkToIceBergPipeline.class
                .getClassLoader().getResourceAsStream("wired-record-443707-u8-618011b336b0.json"));
        ...
        SingleOutputStreamOperator<StatementAccount> statementAccounts = pubSubMessages.map(msg -> {
            ...
            StatementAccount statementAccount = objectMapper.treeToValue(statementAccountNode, StatementAccount.class);
            System.out.println(statementAccount.toString());
            return statementAccount; // Convert JSON to StatementAccount object
        });
        ...
        SingleOutputStreamOperator<RowData> statementAccountRowData = statementAccounts.map(statementAccount -> {
            ...
            row.setField(0, statementAccount.getAccountNo() == null ? null: StringData.fromString(statementAccount.getAccountNo()));
            ...
            row.setField(5, TimestampData.fromLocalDateTime(LocalDateTime.now()));  // data_fetched_date
            row.setField(6, StringData.fromString("TEST_FIP_ID"));  // fip_id
            ...
            row.setField(12, TimestampData.fromLocalDateTime(LocalDateTime.now()));
            row.setField(13, TimestampData.fromLocalDateTime(LocalDateTime.now()));
            return row;
        });
        ...
        Schema accountSummarySchema = new Schema(
                ...
                Types.NestedField.optional(6, "data_fetched_date", Types.TimestampType.withoutZone()),
                ...
                Types.NestedField.optional(11, "fetch_count", Types.IntegerType.get()),
                Types.NestedField.optional(12, "consent_revoked_date", Types.DateType.get()),
                Types.NestedField.optional(13, "created_on", Types.TimestampType.withoutZone()),
                Types.NestedField.optional(14, "updated_on", Types.TimestampType.withoutZone())
        );
            ...
            public void flatMap(JsonNode message, Collector<RowData> out) throws Exception {
                ...
                if (xnsArray.isArray()) {
                    for (JsonNode xnNode : xnsArray) {
                        ...
                        row.setField(8, TimestampData.fromLocalDateTime(LocalDateTime.now()));
                        row.setField(9, StringData.fromString("122024")); // Dummy Period
                        ...
                        row.setField(16, TimestampData.fromLocalDateTime(LocalDateTime.now()));
                        row.setField(17, TimestampData.fromLocalDateTime(LocalDateTime.now()));
        ...
        Schema depositTransactionSchema = new Schema(
                ...
                Types.NestedField.optional(9, "transaction_timestamp", Types.TimestampType.withoutZone()),
                ...
                Types.NestedField.optional(17, "created_on", Types.TimestampType.withoutZone()),
                Types.NestedField.optional(18, "updated_on", Types.TimestampType.withoutZone())
        );
